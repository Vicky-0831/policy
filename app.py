...
STRUCTURE = {
    "国家": {
        "国家卫健委": {
            ...
            "绩效监测": ["2025版公立医院绩效监测操作手册"],
            "基本药物": ["基药目录管理办法通知", "国家基本药物目录管理办法", "2026年版基药目录管理办法"],
            "超品规备案": [],
            "医院管理质控": ["2025年药事管理医疗质量控制指标"],
            "其他": []
        },
        "国家医保局": {
            "国谈落地": ["2025年版国家医保药品目录通知", "做好谈判药品落地工作的通知"],
            "红黄标": ["挂网药品价格风险预警标识通知"],
            "基金监管": ["2026年医保基金监管工作通知"],
            "VBP": [], "DRG/DIP": [],
            "其他": ["药品RWE综合价值评价指南征求意见", "RWE国家可信评价点网络公约公告", "支持创新药高质量发展若干措施", "药品RWE综合价值评价系列指南汇总"]
        }
    },
    "地方": {
        "北京": ["第二批DRG付费新药新技术除外支付工作通知"],
        "广东": ["集采药品接续采购公告（第1号）", "集采药品接续采购公告（第2号）", "集采药品接续采购公告（第3号）", "集采药品接续采购公告（第4号）"],
...
LINKS = {
    # 地方文件
    "第二批DRG付费新药新技术除外支付工作通知": BASE_URL + "bj_drg.pdf",
