...
LINKS = {
    ...
    "浙江省医疗保障局关于支持创新医药高质量发展的若干措施":BASE_URL + "zhejiangYIBAO.pdf",
        ...
        <div class="right-content-box">
            <div class="content-sub-row">
                <div class="grid-cells-wrapper">
                    <div class="inner-cell bg-light-green" style="flex: 1;"><div class="cell-t1">Emb纳入双通道</div><div class="cell-t3">·20省</div></div>
                    <div class="inner-cell bg-light-green" style="flex: 1;"><div class="cell-t1">Cre Oral纳入双通道</div><div class="cell-t3">·29省</div></div>
                </div>
            </div>
            <div class="content-sub-row">
                <div class="grid-cells-wrapper">
                    <div class="inner-cell bg-light-green" style="flex: 1;"><div class="cell-t1">Cre Oral</div><div class="cell-t2">双通道单独支付</div><div class="cell-t3">·21省</div></div>
                    <div class="inner-cell bg-light-green" style="flex: 1;"><div class="cell-t1">Emb/Cre Oral</div><div class="cell-t2">医保总额单列/合理调整</div><div class="cell-t3">·16省医保总额单列<br>·14省医保总额合理调整</div></div>
                    <div class="inner-cell bg-light-green" style="flex: 1;"><div class="cell-t1">Emb/Cre Oral</div><div class="cell-t2">DRG、DIP除外支付/超支补偿</div><div class="cell-t3">·2省3年除外<br>·10省2年除外<br>·2省1年除外<br>·14省超支补偿</div></div>
                </div>
            </div>
        </div>
    </div>
    ...
    if st.session_state.l1 == "国家":
        ...
        nat_struct = {
            "国家卫健委": {
                ...
                "基本药物": ["基药目录管理办法通知", "国家基本药物目录管理办法", "2026版基药目录管理办法","国家基本药物目录2026年版","关于印发国家基本药物目录2026年版本的通知"],
            ...
            "国家医保局": {
                ...
                "VBP": ["关于组织医药机构报送第12批国家组织药品集中带量采购品种需求量的通知","关于公布第12批国家组织药品集中带量采购中选结果的通知"], 
                "DRG/DIP": [],
            ...
            if selected_prov:
                ...
                if selected_prov == "河北":
                    ...
                    st.markdown(
                        ...
                        f'style="font-size:12px; color:#0066cc;">🔗 查看原文</a></div>',
                        unsafe_allow_html=True)
                elif selected_prov == "山西":
                    st.markdown("### 山西省 - 红黄标政策要点")
                    metrics_html = '''
                    <div class="metric-grid">
                        <div class="metric-card" style="border-left-color: #28a745; background-color: #e6fffa;">
                            <div style="font-size:11px; color:#666;">是否明确比例</div>
        ...
        if talk_topic == "红黄标":
            ...
            st.markdown(f'<div class="file-card"><b>面向医疗机构-建议兼顾药品价格和临床诊疗需求，制定科学合理的红黄标分类监测要求</b><br><a href="{url}" target="_blank" style="font-size:12px; color:#0066cc;">🔗 查看原文</a></div>', unsafe_allow_html=True)
        elif talk_topic == "DRG/DIP":
            st.markdown("### DRG/DIP有关话术")
            url = LINKS.get("DRG/DIP3.0政策倡导建议沟通要点", "#")
            st.markdown(f'<div class="file-card"><b>DRG/DIP3.0政策倡导建议沟通要点</b><br><a href="{url}" target="_blank" style="font-size:12px; color:#0066cc;">🔗 查看原文</a></div>', unsafe_allow_html=True)
