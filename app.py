...
st.markdown("""
    ...
    .st-key-back_btn button p {
        font-size: 11px !important; /* 11px 极小文字 */
        color: #666 !important;
    }
...
# L2: 内容展示
    ...
    # 微型返回按钮：设置 key="back_btn" 且不开启 use_container_width
